resource "google_bigquery_table" "strava_activity" {
  ...
  schema              = file("${var.code}/fitnessllm-dataplatform/fitnessllm_dataplatform/stream/strava/schemas/bronze/json/activity.json")
...
resource "google_bigquery_table" "strava_athlete_summary" {
  ...
  schema              = file("${var.code}/fitnessllm-dataplatform/fitnessllm_dataplatform/stream/strava/schemas/bronze/json/athlete_summary.json")
  deletion_protection = var.environment == "dev" ? false : true
...
resource "google_bigquery_table" "strava_altitude_stream" {
  ...
  schema              = file("${var.code}/fitnessllm-dataplatform/fitnessllm_dataplatform/stream/strava/schemas/bronze/json/generic_stream.json")
  deletion_protection = var.environment == "dev" ? false : true
  clustering          = ["athlete_id", "activity_id"]
  table_constraints {
    primary_key {
...
resource "google_bigquery_table" "strava_latlng_stream" {
  ...
  schema              = file("${var.code}/fitnessllm-dataplatform/fitnessllm_dataplatform/stream/strava/schemas/bronze/json/latlng.json")
  deletion_protection = var.environment == "dev" ? false : true
  clustering          = ["athlete_id", "activity_id"]
  table_constraints {
    primary_key {
